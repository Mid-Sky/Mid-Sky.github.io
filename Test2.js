...
function preload() {
    ...
    activeSound = loadSound("activeMute.mp3")
    deactiveSound = loadSound("deactiveMute.mp3")
...
function setup() {
    ...
    //WORK HEREEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
...
function draw() {
    ...
    if (stage == -100) {
        loseScreen()
    }//close if stage == -100 (lose)

    if ((keyCode === 13) && (stage == 0)) {
...
function stage1() {
    ...
    gameTime = int((totalTime - introTime) / 1000) //convert into seconds
    textSize(30)
    stroke(20)
    strokeWeight(5)
    fill('rgba(0,0,255,0.25)')
    ...
    if ((value_mouse_coin <= 70)) {
        ...
        textAlign(CENTER)
        fill("maroon")
        text("Current Balance: " + coinValue, max_width - 150, 0 + 250)
        text("Shining gold coin(s),\n perhaps you can do \nsomething with it. \n(Not Pickupable)", max_width - 150, 0 + 50 + 250)
...
function stage2() {
    ...
    if ((value_mouse_coin <= 70)) {
        ...
        textAlign(CENTER)
        fill("maroon")
        text("Current Balance: " + coinValue2, max_width - 500 - 150, 0 + 250)
        text("Shining gold coin(s),\n perhaps you can do \nsomething with it. \n(Not Pickupable)", max_width - 500 - 150, 0 + 50 + 250)
    }// close collision of coin info

    ///////////Timer
    gameTime = gameTime //stop gameTimer
    gameTime2 = int((totalTime - introTime - (gameTime * 1000)) / 1000) //convert into seconds
    textSize(30)
    stroke(20)
    strokeWeight(5)
    fill('rgba(0,0,255,0.25)')
